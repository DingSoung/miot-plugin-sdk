...
| audioRecordCodec | <code>MISSCodec</code> | 对讲音频的 |
...
| recordingVideoParam | <code>object</code> | 限制录制视频时的分辨率，开始录制视频前，要调整分辨率到指定分辨率。 since 10041 {width:111, height:111} |
| isFull | <code>boolean</code> | 画面是否填充满屏幕 |
| whiteBackground | <code>boolean</code> | 是否使用白色背景 |
